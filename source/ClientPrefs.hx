...
class ClientPrefs {
	...
	public static var playedEvening:Bool = false;
	public static var playedNight:Bool = false;
	public static var playedMorning:Bool = false;
	public static var playedDay:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.playedEvening = playedEvening;
		FlxG.save.data.playedNight = playedNight;
		FlxG.save.data.playedMorning = playedMorning;
		FlxG.save.data.playedDay = playedDay;
