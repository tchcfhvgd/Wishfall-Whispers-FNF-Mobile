...
class PreferencesSubstate extends MusicBeatSubstate
{
	...
	private var showCharacter:FlxSprite = null;
	...
	public function new()
	{
		...
		showCharacter = new FlxSprite().loadGraphic(Paths.image('glut'));
		showCharacter.setGraphicSize(Std.int(showCharacter.width * 1.5));
		showCharacter.updateHitbox();
		showCharacter.setPosition(showCharacter.x + 900, showCharacter.y + 200);
		//s//howCharacter.dance();
		add(showCharacter);
